            ...
            <div className="landing-layout-inner">
                    ...
                    <div className="editorial-content-layer">
                        ...
                        <div className="editorial-footer">
                            ...
                            <div className="editorial-actions">
                                <Link to="/register" className="btn-primary" style={{ textDecoration: 'none' }}>Get Started Today</Link>
                                <a href="#how-it-works" className="btn-outline" style={{ background: 'white', borderColor: 'var(--border-color)', color: 'var(--secondary)', textDecoration: 'none' }}>See How It Works</a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="send-smarter-section premium-smarter-section reveal-on-scroll" ref={addToRefs}>
                    ...
                    <div className="smarter-content-layer">
                        <div className="editorial-giant-text">
                            <h1 className="giant-text">SEND</h1>
                            <h1 className="giant-text">SMARTER</h1>
                        </div>
                    </div>
                </section>
                ...
                {/* Premium Success Wall (Bento Grid) */}
                <section className="section-padding bento-success-section reveal-on-scroll" ref={addToRefs}>
                    <div className="bento-container">
                        <div className="bento-header">
                            <h2 className="signature-font">Movement in Numbers.</h2>
                            <p>Global trust built on every single transaction.</p>
                        </div>
                        ...
                        <div className="bento-grid">
                            ...
                            {/* Testimonial 1 */}
                            <div className="bento-card bento-testimonial">
                                <div className="test-user">
                                    <div className="user-avatar" style={{ background: '#FFEDD5', color: '#9A3412' }}>AB</div>
                                    <div className="user-info">
                                        <div className="user-name">A. Boateng</div>
                                        <div className="user-location">Toronto, CA</div>
                                    </div>
                                </div>
                            ...
                            {/* Stat 2 - Compact */}
                            <div className="bento-card bento-stat-compact success-theme">
                            ...
                            <div className="bento-card bento-testimonial">
                                <div className="test-user">
                                    <div className="user-avatar" style={{ background: '#DBEAFE', color: '#1E40AF' }}>JM</div>
                                    <div className="user-info">
                                        <div className="user-name">J. Mensah</div>
                                        <div className="user-location">Accra, GH</div>
                                    </div>
                                </div>
                            ...
                            {/* Stat 3 - Compact */}
                            <div className="bento-card bento-stat-compact primary-theme">
                                <div className="stat-value">Instant</div>
                                <div className="stat-label">Average Payout Speed</div>
                            </div>

                            {/* Testimonial 3 - Wide */}
                            <div className="bento-card bento-testimonial bento-wide">
                                <div className="test-user">
                                    <div className="user-avatar" style={{ background: '#F0FDF4', color: '#166534' }}>KA</div>
                                    <div className="user-info">
                                        <div className="user-name">K. Asare</div>
                                        <div className="user-location">Montreal, CA</div>
                                    </div>
                                </div>
                            ...
                            <div className="bento-card bento-testimonial">
                                <div className="test-user">
                                    <div className="user-avatar" style={{ background: '#FAF5FF', color: '#6B21A8' }}>MO</div>
                                    <div className="user-info">
                                        <div className="user-name">M. Osei</div>
                                        <div className="user-location">Kumasi, GH</div>
                                    </div>
                                </div>
                ...
                <section className="faq-section reveal-on-scroll" id="faq" ref={addToRefs}>
                    <div className="faq-header">
                        <h2 className="signature-font">Stated Simply.</h2>
                    </div>
                    <div className="editorial-faq-container">
                        {[
                            ...
                            <div className="editorial-faq-item" key={index} style={{ borderBottom: '1px solid var(--border-color)', padding: '32px 0' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer' }}>
                                    <strong style={{ fontSize: '1.4rem', color: 'var(--secondary)', transition: 'color 0.2s' }}>{faq.q}</strong>
                                    <span style={{ color: 'var(--primary)', fontWeight: 'bold', fontSize: '1.5rem' }}>+</span>
                                </div>
                                <p style={{ marginTop: '20px', color: 'var(--text-muted)', lineHeight: '1.8', fontSize: '1.1rem' }}>{faq.a}</p>
                            </div>
                        ))}
                    </div>
                </section>
